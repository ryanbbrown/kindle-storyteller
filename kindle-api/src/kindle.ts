...
export class Kindle {
  ...
  /**
   * Make a custom request to any Amazon endpoint using the authenticated client
   * This allows access to endpoints not yet implemented in the library
   *
  ...
  /**
   * Get the HTTP client instance to access session tokens
   *
